...
export PATH="/code/git-fuzzy/bin:$PATH"
...
alias d=ranger
alias neofetch="neofetch --size 50% --distro_shorthand on --speed_shorthand on --source ~/.wallpapers/sunset-pond.png --disable theme --disable icons --disable packages"
